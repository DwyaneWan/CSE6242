...
def GatherAllEdges(api, root_user, no_of_neighbours):
    ...
    all_edges = []
    all_edges.extend(getPrimaryFriends(api, root_user, no_of_neighbours))
    all_edges.extend(getNextLevelFriends(api, root_user, no_of_neighbours))
    all_edges.extend(getNextLevelFollowers(api, root_user, no_of_neighbours))
